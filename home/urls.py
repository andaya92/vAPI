...
urlpatterns = [
	...
	#######################
	#	User location
	path("uqq/location/new/", views.UserLocationAPI.as_view(), name="UserLocationAPI"),
	path("uqq/location/update/", views.UserLocationAPI.as_view(), name="UserLocationAPI"),
	path("uqq/location/<int:user_id>/", views.UserLocationAPI.as_view(), name="UserLocationAPI"),

	path("uqq/tags/new/", views.UserInterestSkillTagsAPI.as_view(), name="UserInterestSkillTagsAPI"),
	path("uqq/tags/update/", views.UserInterestSkillTagsAPI.as_view(), name="UserInterestSkillTagsAPI"),
	path("uqq/tags/<int:user_id>/", views.UserInterestSkillTagsAPI.as_view(), name="UserInterestSkillTagsAPI"),
	...
	path("volunteer_event/location/<str:location>/", views.VolunteerEventAPI.as_view(), name="get_vol_event"),
	# Posts
	path("volunteer_post/new/", views.VolunteerPostAPI.as_view(), name="vol_post"),
	path("volunteer_post/delete/", views.VolunteerPostDeleteAPI.as_view(), name="vol_post"),
